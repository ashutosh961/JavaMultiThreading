...
<b>How do you create threads in Java ? </b>
...
<b>How do you create a thread with a Runnable interface ? </b>
...
<b>What are the different states of thread life cycle ? </b>
...
<b>What is a critical section ? </b>
...
<b>What are two scenarios under which a race condition occurs ? </b>
...
<b>How do we prevent a Race condition ? </b>
...
<b>How do we achieve synchronization between threads trying to access shared resources ?</b>

Synchronization between threads can be achieved by using mutex, semaphores and monitors.

<b>How do Mutex, Semaphores and Monitors achieve thread synchronization ? </b>
...
<b>What are the different types of Semaphores ?</b>
...
<b>Which are the higher level synchronization constructs ?</b>

Monitor is a higher level synchronization construct.

<b>Which are the lower level synchronization constructs ?</b>

Sempahores and Monitors are lower level synchronization constructs.

<b>What problems need to be avoided while designing monitors ?</b>

Missed Signals Busy Waiting Slipped Condition Spurious Wakeup

<b>How are monitors implemented in Java ?</b>
...
<b>What is a nested monitor lockout ?</b>
...
<b>What is a cyclic barrier ?</b>

A cyclic barrier is a point in code where an incoming thread blocks. The threads are only released once all threads reach that point in code. Hence it acts as a barrier. Each cyclic

barrier has a count which gets reset once all threads have crossed the barrier and can be used again for next incoming threads. Hence it is called a cyclic barrier.

<b>What is a count down latch ?</b>
...
<b>What is a Producer Consumer problem ?</b>
...
<b>Which are the three ways to achieve parallelism?</b>
...
<b>What is the same threaded system ?</b>
